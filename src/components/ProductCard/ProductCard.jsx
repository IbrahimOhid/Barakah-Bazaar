                    ...
                    >
                      ...
                      <div className="relative overflow-hidden rounded-2xl sm:rounded-[26px]">
                        ...
                        <div className="absolute inset-x-0 bottom-3 flex translate-y-6 items-center justify-center gap-1.5 opacity-100 transition-all duration-500 sm:bottom-5 sm:gap-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100">
                          {/* VIEW */}
                          <button className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/95 text-slate-700 shadow-md backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:text-indigo-600 sm:h-11 sm:w-11 sm:rounded-2xl">
                            <HiOutlineEye className="h-4 w-4 sm:h-5 sm:w-5" />
                          </button>
      
                          {/* WISHLIST */}
                          <button className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/95 text-slate-700 shadow-md backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:text-rose-500 sm:h-11 sm:w-11 sm:rounded-2xl">
                            <HiOutlineHeart className="h-4 w-4 sm:h-5 sm:w-5" />
                          </button>
      
                          {/* ADD TO CART */}
                          <button className="flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-md shadow-indigo-200 transition-all duration-300 hover:-translate-y-0.5 hover:bg-indigo-700 sm:h-11 sm:w-11 sm:rounded-2xl">
